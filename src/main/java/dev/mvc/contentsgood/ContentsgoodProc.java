...
public class ContentsgoodProc implements ContentsgoodProcInter {
  ...
  @Override
  public ContentsgoodVO readByContentsnoUsersno(HashMap<String, Object> map) {
    ContentsgoodVO contentsgoodVO = this.contentsgoodDAO.readByContentsnoUsersno(map);
    return contentsgoodVO;
  }

  @Override
  public ArrayList<ContentsContentsgoodUsersnoVO> list_all_join() {
    ArrayList<ContentsContentsgoodUsersnoVO> list = this.contentsgoodDAO.list_all_join();
    return list;
  }
